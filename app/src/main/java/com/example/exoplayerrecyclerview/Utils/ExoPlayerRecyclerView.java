package com.example.exoplayerrecyclerview.Utils;
...
import com.example.exoplayerrecyclerview.Adapter.PlayerViewHolder;
...
public class ExoPlayerRecyclerView extends RecyclerView {
  ...
  private void init(Context context) {
    ...
    videoSurfaceView.setUseController(true); //Video will auto start while listing will be loaded.
